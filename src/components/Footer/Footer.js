      ...
      <div className="footerBox">
        ...
        <div className="footerRight">
          ...
          <div className="footerCompanyInformation">
            ...
            <a className="textDecorationNone marginLeft5" href="www.naver.com">
              사업자정보 확인
            </a>
            <br />
